...
public class DefaultOptions {
    ...
    final static ServerOption[] defaultServerOptions = {
        ...
        new ServerOption(ServerOptionKeys.serverOptionSpawnCommand, "Option: Enable or disable '/spwawn' command. Does not disable '/wxw spawn'. Default: false", "boolean", false, "WormholeXTremeWorlds"),
