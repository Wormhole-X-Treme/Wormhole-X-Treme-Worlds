...
public class DefaultOptions {
    ...
    final static ServerOption[] defaultServerOptions = {
        new ServerOption(ServerOptionKeys.serverOptionPermissions, "Option: Enable or disable Permissions plugin support. Default: true (enable)", "boolean", true, "WormholeXTremeWorlds"),
        new ServerOption(ServerOptionKeys.serverOptionOpsBypassPermissions, "Option: Ops bypass Permissions plugin access checks. Default: true (enabled)", "boolean", true, "WormholeXTremeWorlds"),
        new ServerOption(ServerOptionKeys.serverOptionHelp, "Option: Enable or disable Help plugin support. Default: true (enabled)", "boolean", true, "WormholeXTremeWorlds"),
        new ServerOption(ServerOptionKeys.serverOptionSpawnCommand, "Option: Enable or disable '/spwawn' command. Does not disable '/wxw spawn'. Default: false (disabled)", "boolean", false, "WormholeXTremeWorlds"),
        new ServerOption(ServerOptionKeys.serverOptionTimelock, "Option: Enable or disable timelock functionality. Default: true (enabled)", "boolean", true, "WormholeXTremeWorlds"),
